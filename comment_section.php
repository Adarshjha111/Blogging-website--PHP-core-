...
<body>
    ...
    <?php include 'partials/_nav_loggedin.php';?>
    <?php
    ...
    $sql = "SELECT * FROM `user_comments` WHERE post_id=$post_id"; 
    ...
    if($method=='POST'){
        ...
        ini_set('display_errors',1);
            ...
            /*** THIS! ***/
            mysqli_report(MYSQLI_REPORT_ERROR | MYSQLI_REPORT_STRICT);
        $sql = "INSERT INTO `user_comments` ( `comment`, `post_id`, `username`) VALUES ('$comment', '$post_id', '$username')";
        $result = mysqli_query($mysqli, $sql);
        $showAlert = true;
        if($showAlert){
    ...
    <div class="container my-4">
        <div class="jumbotron">
            ...
            <p>Posted by: <em><?php echo $username; ?></em></p>
        </div>
    </div>
    ...
    while($row = mysqli_fetch_assoc($result)){
        ...
        echo '<div class="media my-3">
            ...
            <div class="media-body">
               <p class="font-weight-bold my-0">'. $row['username'] .' at '. $post_date. '</p> '. $comment . '
            </div>
        </div>';
